...
<div id="container">
    ...
    <div id="content">
        <div class="image">
            <img src="<%request.getParameter("image");%>" width="200" height="200" style="background-color: white;">
            <a href=""></a>
        </div>
        ...
        <div class="information">
            <table class="info">
                <tr>
                    <td><label><font size="20px"><%request.getParameter("name");%></font></label></td>
                </tr>
                <tr style="height: 5px">
                ...
                <tr>
                    <td><label>Bday: <%request.getParameter("bday");%></label></td>
                </tr>
                <tr>
                    <td><label>City: <%request.getParameter("city");%></label></td>
                </tr>
                <tr>
                    <td><label>Gender: <%request.getParameter("gender");%></label></td>
                </tr>
                <tr>
                    <td><label>E-mail: <%request.getParameter("email");%></label></td>
                </tr>
                <tr>
