...
<div class="main">
    ...
    <div class="news">
        <div class="type">
            <h3 style="background-image: url('https://worldcuprussia.com/football/stadiums/original/2017/04/58f0ce579f3ed.jpg');">News</h3>
        ...
        <div class="type">
            <h3 style="background-image: url('http://img-fotki.yandex.ru/get/6743/7586803.3/0_81d06_be454b15_orig.jpg')">Articles</h3>
        ...
        <div class="type">
            <h3 style="background-image: url('http://stadiumdb.com/pictures/stadiums/rus/luzniki/luzniki19.jpg')">Blog</h3>
        ...
        <div class="addnews">
            <a href="/worldcup/admin/addnews.jsp">Add News</a>
        </div>
    </div>
